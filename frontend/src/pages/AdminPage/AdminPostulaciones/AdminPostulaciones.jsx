  ...
  return (
    <>
      <div className="admin-layout">
        <main className="main-postulaciones-page-AP">
          <div className="container-postulaciones-manage">
            {/* Header Section */}
                ...
                {postulacionesFiltradas.map(p => (
                  <tr key={p.id} className={`row-${p.estado?.toLowerCase()}`}>
                    ...
                    <td className="actions-AP">
                      {editingId === p.id ? (
                        <>
                          <button className="btn-action-AP btn-save-AP" onClick={handleSaveEdit} disabled={processingId === p.id} title="Guardar">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                              <polyline points="20,6 9,17 4,12"></polyline>
                            </svg>
                          </button>
                          <button className="btn-action-AP btn-cancel-AP" onClick={handleCancelEdit} title="Cancelar">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <>
                          <button className="btn-action-AP btn-edit-AP" onClick={() => handleEdit(p)} disabled={processingId === p.id} title="Editar estado">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                          ...
                          <button className="btn-action-AP btn-delete-AP" onClick={() => handleEliminar(p.id)} disabled={processingId === p.id} title="Eliminar">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
