        ...
        <section className="section-hero">
          ...
          <div className="hero-container">
            ...
            <p className="hero-subtitle">
              Miles de ofertas de empresas verificadas esperándote. Conecta con
              empleadores comprometidos hoy mismo.
            </p>
        ...
        <section className="section-companies">
          <div className="section-header-content">
            ...
            <p className="section-description">
              Proceso simple y efectivo para conectar con profesionales
              calificados
            </p>
          </div>
          ...
          <div className="steps-container">
            <div className="step-card">
              ...
              <p className="step-desc">
                Crea tu cuenta y publica ofertas ilimitadas. Llega a miles de
            ...
            <div className="step-card">
              ...
              <p className="step-desc">
                Accede a perfiles detallados y filtra según tus necesidades
            ...
            <div className="step-card">
              ...
              <p className="step-desc">
                Contacta directamente al candidato ideal que mejor encaja con tu
                organización.
              </p>
            </div>
          </div>
        ...
        <section className="section-trusted">
          <div className="trusted-header">
            ...
            <p className="trusted-subtitle">
              Más de 800 empresas utilizan Workable para encontrar el mejor
              talento profesional
            </p>
          </div>
        ...
        <section className="section-applicants">
          <div className="applicants-grid">
            <div className="applicants-image">
              <img
                src="https://i.ibb.co/ymHWpjzF/negocios-finanzas-y-empleo-concepto-de-mujeres-emprendedoras-exitosas-confianza-empresaria-asiatica.jpg"
                alt="Candidatos"
                className="img-applicants"
              />
            </div>
            ...
            <div className="applicants-content">
              ...
              <p className="applicants-text">
                Estamos aquí para ayudarte a encontrar tu empleo ideal. Miles de
                ofertas inclusivas te están esperando.
              </p>
              <p className="applicants-text">
                Regístrate o inicia sesión de forma gratuita, aplica a ofertas
                de empresas comprometidas con la inclusión laboral.
              </p>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-description">
                Maximiza el alcance de tus ofertas entre una amplia audiencia de
                candidatos calificados en toda la región.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Fortalece tu compromiso con la inclusión y responsabilidad
                social empresarial.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Publica vacantes sin costos y organiza postulaciones de manera
                simple y efectiva.
              </p>
            </div>
          </div>
