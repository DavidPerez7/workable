    ...
    <>
      ...
      <main className="main-info-rec-IRP">
        <div className="header-section1-IRP">
          <h1>
            <Link to="/" className="link-page-IRP">
              Personas
            </Link>
          </h1>
        ...
        <section className="section-promo-IRP">
          ...
          <p className="text-promo-IRP">
            Ahorra costos y tiempo en tus procesos de selección y consigue el
            candidato ideal de forma rápida y fácil
          </p>
        ...
        <section className="section-process-IRP">
          <div className="column-images-IRP">
            <img
              src="https://media.istockphoto.com/id/1440285048/es/foto/%C3%A9xito-visi%C3%B3n-y-orgulloso-l%C3%ADder-gerente-que-se-ve-feliz-y-sonr%C3%ADe-liderazgo-con-innovaci%C3%B3n-en-el.jpg?s=612x612&w=0&k=20&c=NA9BvKkZdocPJNsqUZzl_bPfmGzqS_BUj00SZazloCs="
              alt="Persona 1"
              className="image-process-IRP"
            />
            <img
              src="https://media.istockphoto.com/id/1754234512/es/foto/empresario-hombre-y-brazos-cruzados-en-un-taller-con-sonrisa-y-confianza-para-el-retrato-en.jpg?s=612x612&w=0&k=20&c=IDLiVjG-l8IEqA2NPTP_5Jqyk7boFGp0ubc_WGm44ks="
              alt="Persona 2"
              className="image-process-IRP image-bottom-IRP"
            />
          </div>
          ...
          <div className="column-steps-IRP">
            ...
            <div className="process-step-IRP">
              ...
              <div>
                ...
                <p className="step-text-IRP">
                  Selecciona a los mejores candidatos entre todos CVs recibidos.
                </p>
              </div>
            </div>
            <div className="process-step-IRP">
        ...
        <section className="section-cta-middle-IRP">
          ...
          <p className="text-cta-middle-IRP">
            Serán tus 5 minutos de hoy mejor invertidos
          </p>
          <button className="button-find-candidates-IRP">
            <span>
              <Link to="/Reclutador/Publicacion">Encontrar candidatos</Link>
            </span>
          </button>
        </section>
        ...
        <section className="section-features-IRP">
          <div className="feature-card-IRP">
            ...
            <h3 className="feature-title-IRP">
              Atrae al candidato que necesitas
            </h3>
            <p className="feature-text-IRP">
              Enumera las habilidades necesarias para el empleo para que puedan
              aplicarse candidatos pertinentes.
            </p>
          </div>
          ...
          <div className="feature-card-IRP">
            ...
            <p className="feature-text-IRP">
              Personaliza el proceso de selección de cada oferta: definición de
              etapas, test y mucho más.
            </p>
          </div>
          ...
          <div className="feature-card-IRP">
            ...
            <p className="feature-text-IRP">
              Ordena los CV, envía mensajes y entrevístalos, todo en la web de
              empleo más utilizada en Latinoamérica.
            </p>
          </div>
        </section>
