...
const ReclutadorForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const camposRequeridos = ["nombre", "apellido", "correo", "telefono", "password", "confirmPassword", "fechaNacimiento", "municipioId"];
  ...
  return (
    <div className="reclutador-form-container">
      <div className="reclutador-form-card">
        <div className="reclutador-form-header"></div>
        ...
        <form className="reclutador-form" onSubmit={handleSubmit} ref={formRef}>
          ...
          <div className="form-field checkbox-field">
            <label className="checkbox-label">
              <input type="checkbox" checked={compromisoInclusivo} onChange={(e) => setCompromisoInclusivo(e.target.checked)} required />
        ...
        <p className="new-reclutador-link">
          ¿Deseas ser reclutador de una empresa? <a href="/SignUpPage/NewReclutador" className="new-reclutador-anchor">Regístrate aquí</a>
        </p>
