...
import com.workable_sb.workable.mapper.usuario.UsrReclutadorMapper;
...
public class UsrReclutadorServiceImple implements UsrReclutadorService {
    ...
    return reclutadorRepository.findById(safeId)
    ...
    return reclutadorRepository.findById(safeId)
            ...
            .map(reclutador -> {
                ...
                reclutador = Objects.requireNonNull(reclutador, "No se pudo mapear la entidad UsrReclutador");
                UsrReclutador actualizado = reclutadorRepository.save(reclutador);
                actualizado = Objects.requireNonNull(actualizado, "No se pudo guardar la entidad UsrReclutador");
    ...
    Integer safeId = Objects.requireNonNull(id, "El id no puede ser nulo");
    reclutadorRepository.deleteById(safeId);
    }
}
