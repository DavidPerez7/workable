...
public class EmpresaService {
    ...
    public void delete(Long id, Long usuarioIdActual) {
        ...
        // First, remove postulaciones that belong to offers of this company to avoid FK constraint
    ...
    public void deleteAdmin(Long id) {
        ...
        // Remove postulaciones for all offers to avoid FK constraints and then delete
        for (Oferta oferta : existingEmpresa.getOfertas()) {
            postulacionRepo.deleteAll(postulacionRepo.findByOfertaId(oferta.getId()));
        }
